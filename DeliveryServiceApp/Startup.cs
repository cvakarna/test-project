...
namespace DeliveryServiceApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1",new Swashbuckle.AspNetCore.Swagger.Info { Title="DeliveryServiceApi",Version="v1" });
            });

            services.AddScoped<ICustomer,CustomerServiceApi>();
            services.AddScoped<IOrderService, OrderServiceApi>();
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "DeliveryServiceApi  V1");
            });
